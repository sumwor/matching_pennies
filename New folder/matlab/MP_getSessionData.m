...
trialData.startloop=CODE(CODE==EVENT.STARTLOOP);
trialData.startloopTimes=time(CODE==EVENT.STARTLOOP);
trialData.startchoicecount=CODE(CODE==EVENT.CHOICECOUNTSTART);
trialData.startchoicecountTimes=time(CODE==EVENT.CHOICECOUNTSTART);
trialData.endchoicecountTimes=time(CODE==EVENT.CHOICECOUNTEND);
trialData.starttestTimes=time(CODE==EVENT.TESTSTART);
trialData.endtestTimes=time(CODE==EVENT.TESTEND);

trialData.endloop=CODE(CODE==EVENT.ENDLOOP);
trialData.endloopTimes=time(CODE==EVENT.ENDLOOP);
