...
int waterAmount_left = int(get_parameterValue(ini_pathname,"waterAmount_left",60.0)); # Valve open duration in ms
int waterAmount_right = int(get_parameterValue(ini_pathname,"waterAmount_right",75.0));	
...
double meanNL = double(numNLs) / numTrials; 
